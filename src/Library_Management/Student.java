...
public class Student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(324, 487));
    ...
    private void btnregisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregisterActionPerformed
        try {
            String sql = "INSERT INTO student(Sid, Sname, Snumber, Scourse, ScourseName, year ) VALUES (?,?,?,?,?,?)";
                    
                    
            ps = con.prepareStatement(sql);
            ps.setString(1, txtsid.getText());
            ps.setString(2, txtname.getText());
            ps.setString(3, txtPnumber.getText());
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        try {
            ...
            ps.setString(1, txtsid.getText());
            ps.execute();
            JOptionPane.showMessageDialog(null, "Delete student");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
