...
public class NewBook extends javax.swing.JFrame {
   ...
   /* public void Random(){
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cmbedition, 0, 271, Short.MAX_VALUE)
                                    .addComponent(txtbid)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        setSize(new java.awt.Dimension(391, 521));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            String sql = "UPDATE book SET "
                    +" name=?, edition=?, publisher=?, price=?, stock=? WHERE book_id=? ";
            ps = con.prepareStatement(sql);
          
            ps.setString(1, txtname.getText());
            ps.setString(2, (String) cmbedition.getSelectedItem());
            ps.setString(3, txtpub.getText());
            ps.setString(4, txtprice.getText());
            ps.setString(5, txtstock.getText());
            ps.setString(6, txtbid.getText());
            ps.execute();
