...
public class Statistics extends javax.swing.JFrame {
    ...
    public void tblissue(){
        try {
            String sql = "SELECT bid AS Book_id, bname AS Book_name, sid AS Student_id, sname AS Student_name, date FROM issue";
    ...
    public void tblreturn(){
        try {
            String sql = "select sid AS Student_id, sname AS Student_name,bid AS Book_id, bname AS Book_name,idate AS Issue_date, rdate AS Return_date FROM `return`";
            ps = con.prepareStatement(sql);
            rs = ps.executeQuery();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 39, -1, -1));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 242, -1, -1));
